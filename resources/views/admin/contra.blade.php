...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        سياسة خصوصية
        <small>صفحة سياسة خصوصية</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">صفحة سياسة خصوصية</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">تعديل <small>تعديل صفحة سياسة خصوصية</small></h3>
          <!-- tools box -->
        ...
        <div class="box-body pad">
          <form action="{{route('admin.contra.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="contra_id" value="{{$contra->id}}">
