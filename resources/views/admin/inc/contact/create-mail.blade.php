...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        رسالة جديدة
        <small>إنشاء رسالة جديدة</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">رسالة جديدة</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">كتابة رسالة جديدة</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" placeholder="إلى:">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                {{-- <ul class="wysihtml5-toolbar list-unstyled" style=""><li class="dropdown" style="display:inline-block;">
...
{{-- <textarea id="compose-textarea" class="form-control" style="height: 300px;display:non;">                      &lt;h1&gt;&lt;u&gt;Heading Of Message&lt;/u&gt;&lt;/h1&gt;
                  &lt;h4&gt;Subheading&lt;/h4&gt;
