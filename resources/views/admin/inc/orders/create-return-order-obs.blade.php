...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        إضافة
        <small>إضافة سبب إرجاع الطلب</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">إضافة سبب إرجاع الطلب</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">إضافة<small>سبب إرجاع الطلب</small></h3>
          <!-- tools box -->
        ...
        <div class="box-body pad">
          <form action="{{route('admin.return.order.observation.store')}}" method="POST" enctype="multipart/form-data">
            @csrf            
            <div class="form-group {{$errors->has('obs')? 'has-error':''}}">
                <label for="obs"></label>
                <input type="text" name="obs" class="form-control" placeholder="أكتب سبب إرجاع الطلب" value="{{old('obs')}}">
                @if($errors->has('obs'))
