...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        تعديل
        <small>تعديل سبب إلغاء الطلب</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">تعديل سبب إلغاء الطلب</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">تعديل <small>سبب إلغاء الطلب</small></h3>
          <!-- tools box -->
        ...
        <div class="box-body pad">
          <form action="{{route('admin.deny.order.observation.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
